...
class ImageUploadWidgetComponent(BaseComponent):
    def __init__(self, page: Page, identifier: str):
        ...
        self.image_upload_info_text = page.get_by_test_id(f'{identifier}-image-upload-widget-info-title-text')
    ...
    def check_visible(self, is_image_uploaded: bool = False):
        ...
        expect(self.image_upload_info_text).to_be_visible()
        expect(self.image_upload_info_text).to_have_text('Tap on "Upload image" button to select file')
