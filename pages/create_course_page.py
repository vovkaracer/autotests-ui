...
class CreateCoursePage(BasePage):
    def __init__(self, page: Page):
        ...
        self.preview_empty_course_icon = page.get_by_test_id('create-course-preview-empty-view-icon')
        self.preview_empty_course_title = page.get_by_test_id('create-course-preview-empty-view-title-text')
        self.preview_empty_course_description = page.get_by_test_id('create-course-preview-empty-view-description-text')
        ...
        self.exercise_empty_view_title = page.get_by_test_id('create-course-exercises-empty-view-title-text')
        self.exercise_empty_view_description = page.get_by_test_id(
    ...
    def check_visible_image_preview_empty_view(self):
        expect(self.preview_empty_course_icon).to_be_visible()

        expect(self.preview_empty_course_title).to_be_visible()
        expect(self.preview_empty_course_title).to_have_text('No image selected')

        expect(self.preview_empty_course_description).to_be_visible()
        expect(self.preview_empty_course_description).to_have_text('Preview of selected image will be displayed here')

    def check_visible_image_upload_view(self, is_image_uploaded: bool = False):
        expect(self.preview_image_upload_icon).to_be_visible()

        expect(self.preview_image_upload_text).to_be_visible()
        expect(self.preview_image_upload_text).to_have_text('Tap on "Upload image" button to select file')
    ...
    def check_visible_exercises_empty_view(self):
        ...
        expect(self.exercise_empty_view_title).to_be_visible()
        expect(self.exercise_empty_view_title).to_have_text('There is no exercises')

        expect(self.exercise_empty_view_description).to_be_visible()
        expect(self.exercise_empty_view_description).to_have_text(
    ...
    def check_visible_create_exercise_form(self, index: int, title: str, description: str):
        ...
        exercise_title = self.page.get_by_test_id(f'create-course-exercise-form-title-{index}-input')
        exercise_description = self.page.get_by_test_id(f'create-course-exercise-form-description-{index}-input')
